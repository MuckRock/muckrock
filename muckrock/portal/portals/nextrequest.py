...
class NextRequestPortal(PortalAutoReceiveMixin, ManualPortal):
        ...
        try:
            ...
            data = {
                ...
                'requester[phone_number]':
                    '(617) 299-1832',
                'requester[address]':
                    'Dept MR {} 411A Highland Ave'.format(foia.pk),
                'requester[city]':
                    'Somerville',
                'requester[state]':
                    'MA',
    ...
    def _get(self, session, url, msg, expected_status=200, **kwargs):
        ...
        return self._request(
            'get', session, url, msg, expected_status, **kwargs
        )
    ...
    def _post(self, session, url, msg, expected_status=200, **kwargs):
        ...
        # pylint: disable=too-many-arguments
        return self._request(
            'post', session, url, msg, expected_status, **kwargs
        )
