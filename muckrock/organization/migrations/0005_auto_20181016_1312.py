...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(db_column=b'monthly_requests', default=50),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='organization',
            name='users',
            field=models.ManyToManyField(related_name='organizations', through='organization.Membership', to=settings.AUTH_USER_MODEL),
        ),
