    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='errors',
                        to='communication.EmailCommunication'
                    )
                ),
                (
                    'recipient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'client_os',
                    models.CharField(max_length=10, verbose_name='Client OS')
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='errors',
                        to='communication.FaxCommunication'
                    )
                ),
            ],
            options={
