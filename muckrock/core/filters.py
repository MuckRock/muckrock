...
class AutocompleteModelMultipleChoiceFilter(django_filters.ModelMultipleChoiceFilter):
    """Autocomplete Filter
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(AutocompleteModelMultipleChoiceFilter, self).__init__(*args, **kwargs)

    def get_queryset(self, request):
        queryset = super(AutocompleteModelMultipleChoiceFilter, self).get_queryset(
            request
        )
