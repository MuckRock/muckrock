...
urlpatterns = patterns('',
    ...
    url(r'^reset_pw_done/$',     auth_views.password_reset_done, {'template_name': 'user/pw_reset_part1_done.html'}, name='acct-reset-pw-done'),
    url(r'^reset_pw_complete/$', auth_views.password_reset_complete, {'template_name': 'user/pw_reset_part2_done.html'}, name='acct-reset-pw-complete'),
