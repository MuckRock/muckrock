...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_profile', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='users', null=True, to=orm['organization.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.organization'
        db.delete_column(u'accounts_profile', 'organization_id')
