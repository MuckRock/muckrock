...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Statistics.total_payment_tasks'
        db.add_column(u'accounts_statistics', 'total_payment_tasks',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Statistics.total_payment_tasks'
        db.delete_column(u'accounts_statistics', 'total_payment_tasks')
