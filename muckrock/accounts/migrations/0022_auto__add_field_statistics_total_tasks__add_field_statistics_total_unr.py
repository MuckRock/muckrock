...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Statistics.total_tasks'
        db.add_column(u'accounts_statistics', 'total_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_generic_tasks'
        db.add_column(u'accounts_statistics', 'total_generic_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_generic_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_generic_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_orphan_tasks'
        db.add_column(u'accounts_statistics', 'total_orphan_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_orphan_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_orphan_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_snailmail_tasks'
        db.add_column(u'accounts_statistics', 'total_snailmail_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_snailmail_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_snailmail_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_rejected_tasks'
        db.add_column(u'accounts_statistics', 'total_rejected_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_rejected_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_rejected_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_staleagency_tasks'
        db.add_column(u'accounts_statistics', 'total_staleagency_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_staleagency_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_staleagency_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_flagged_tasks'
        db.add_column(u'accounts_statistics', 'total_flagged_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_flagged_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_flagged_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_newagency_tasks'
        db.add_column(u'accounts_statistics', 'total_newagency_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_newagency_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_newagency_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_response_tasks'
        db.add_column(u'accounts_statistics', 'total_response_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_response_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_response_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


        # Changing field 'Profile.organization'
        db.alter_column(u'accounts_profile', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['organization.Organization']))

    def backwards(self, orm):
        # Deleting field 'Statistics.total_tasks'
        db.delete_column(u'accounts_statistics', 'total_tasks')

        # Deleting field 'Statistics.total_unresolved_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_tasks')

        # Deleting field 'Statistics.total_generic_tasks'
        db.delete_column(u'accounts_statistics', 'total_generic_tasks')

        # Deleting field 'Statistics.total_unresolved_generic_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_generic_tasks')

        # Deleting field 'Statistics.total_orphan_tasks'
        db.delete_column(u'accounts_statistics', 'total_orphan_tasks')

        # Deleting field 'Statistics.total_unresolved_orphan_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_orphan_tasks')

        # Deleting field 'Statistics.total_snailmail_tasks'
        db.delete_column(u'accounts_statistics', 'total_snailmail_tasks')

        # Deleting field 'Statistics.total_unresolved_snailmail_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_snailmail_tasks')

        # Deleting field 'Statistics.total_rejected_tasks'
        db.delete_column(u'accounts_statistics', 'total_rejected_tasks')

        # Deleting field 'Statistics.total_unresolved_rejected_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_rejected_tasks')

        # Deleting field 'Statistics.total_staleagency_tasks'
        db.delete_column(u'accounts_statistics', 'total_staleagency_tasks')

        # Deleting field 'Statistics.total_unresolved_staleagency_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_staleagency_tasks')

        # Deleting field 'Statistics.total_flagged_tasks'
        db.delete_column(u'accounts_statistics', 'total_flagged_tasks')

        # Deleting field 'Statistics.total_unresolved_flagged_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_flagged_tasks')

        # Deleting field 'Statistics.total_newagency_tasks'
        db.delete_column(u'accounts_statistics', 'total_newagency_tasks')

        # Deleting field 'Statistics.total_unresolved_newagency_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_newagency_tasks')

        # Deleting field 'Statistics.total_response_tasks'
        db.delete_column(u'accounts_statistics', 'total_response_tasks')

        # Deleting field 'Statistics.total_unresolved_response_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_response_tasks')


        # Changing field 'Profile.organization'
        db.alter_column(u'accounts_profile', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['organization.Organization']))
    ...
    models = {
        u'accounts.profile': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'members'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['organization.Organization']"}),
        ...
        u'accounts.statistics': {
            ...
            'total_flagged_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_generic_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_newagency_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_orphan_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_page_views': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_pages': ('django.db.models.fields.IntegerField', [], {}),
            'total_rejected_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'total_response_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_snailmail_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_staleagency_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_flagged_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_generic_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_newagency_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_orphan_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_rejected_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_response_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_snailmail_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_staleagency_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
