...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.follow_questions'
        db.add_column('accounts_profile', 'follow_questions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.follow_questions'
        db.delete_column('accounts_profile', 'follow_questions')
