...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(m2m_table_name, (
            ...
            ('question', models.ForeignKey(orm['qanda.question'], null=False))
        ))
        db.create_unique(m2m_table_name, ['profile_id', 'question_id'])


    def backwards(self, orm):
        # Removing M2M table for field follows_question on 'Profile'
        db.delete_table(db.shorten_name('accounts_profile_follows_question'))
