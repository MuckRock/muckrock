...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Statistics.total_requests_awaiting_ack'
        db.add_column('accounts_statistics', 'total_requests_awaiting_ack',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Statistics.total_requests_awaiting_ack'
        db.delete_column('accounts_statistics', 'total_requests_awaiting_ack')
