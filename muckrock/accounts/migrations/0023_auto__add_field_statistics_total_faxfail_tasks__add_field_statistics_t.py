...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Statistics.total_faxfail_tasks'
        db.add_column(u'accounts_statistics', 'total_faxfail_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_faxfail_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_faxfail_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_payment'
        db.add_column(u'accounts_statistics', 'total_payment',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_payment_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_payment_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_crowdfundpayment_tasks'
        db.add_column(u'accounts_statistics', 'total_crowdfundpayment_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.total_unresolved_crowdfundpayment_tasks'
        db.add_column(u'accounts_statistics', 'total_unresolved_crowdfundpayment_tasks',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Statistics.total_faxfail_tasks'
        db.delete_column(u'accounts_statistics', 'total_faxfail_tasks')

        # Deleting field 'Statistics.total_unresolved_faxfail_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_faxfail_tasks')

        # Deleting field 'Statistics.total_payment'
        db.delete_column(u'accounts_statistics', 'total_payment')

        # Deleting field 'Statistics.total_unresolved_payment_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_payment_tasks')

        # Deleting field 'Statistics.total_crowdfundpayment_tasks'
        db.delete_column(u'accounts_statistics', 'total_crowdfundpayment_tasks')

        # Deleting field 'Statistics.total_unresolved_crowdfundpayment_tasks'
        db.delete_column(u'accounts_statistics', 'total_unresolved_crowdfundpayment_tasks')
    ...
    models = {
        ...
        u'accounts.statistics': {
            ...
            'total_crowdfundpayment_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_faxfail_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'total_payment': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'total_unresolved_crowdfundpayment_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'total_unresolved_faxfail_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'total_unresolved_payment_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
