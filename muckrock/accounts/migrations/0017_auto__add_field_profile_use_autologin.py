...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.use_autologin'
        db.add_column(u'accounts_profile', 'use_autologin',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.use_autologin'
        db.delete_column(u'accounts_profile', 'use_autologin')
