...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Statistics.public_notes'
        db.add_column(u'accounts_statistics', 'public_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Statistics.admin_notes'
        db.add_column(u'accounts_statistics', 'admin_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Statistics.public_notes'
        db.delete_column(u'accounts_statistics', 'public_notes')

        # Deleting field 'Statistics.admin_notes'
        db.delete_column(u'accounts_statistics', 'admin_notes')
    ...
    models = {
        ...
        u'accounts.statistics': {
            ...
            'public_notes': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            ...
            'total_payment_tasks': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
