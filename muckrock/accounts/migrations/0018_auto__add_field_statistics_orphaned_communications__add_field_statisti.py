...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Statistics.orphaned_communications'
        db.add_column(u'accounts_statistics', 'orphaned_communications',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.stale_agencies'
        db.add_column(u'accounts_statistics', 'stale_agencies',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Statistics.unapproved_agencies'
        db.add_column(u'accounts_statistics', 'unapproved_agencies',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Statistics.orphaned_communications'
        db.delete_column(u'accounts_statistics', 'orphaned_communications')

        # Deleting field 'Statistics.stale_agencies'
        db.delete_column(u'accounts_statistics', 'stale_agencies')

        # Deleting field 'Statistics.unapproved_agencies'
        db.delete_column(u'accounts_statistics', 'unapproved_agencies')
