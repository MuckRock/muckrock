...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.email_pref'
        db.add_column('accounts_profile', 'email_pref',
                      self.gf('django.db.models.fields.CharField')(default='daily', max_length=10),
                      keep_default=False)

        # Adding M2M table for field notifications on 'Profile'
        m2m_table_name = db.shorten_name('accounts_profile_notifications')
    ...
    def backwards(self, orm):
        # Deleting field 'Profile.email_pref'
        db.delete_column('accounts_profile', 'email_pref')

        # Removing M2M table for field notifications on 'Profile'
        db.delete_table(db.shorten_name('accounts_profile_notifications'))
