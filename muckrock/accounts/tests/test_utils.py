...
class TestUniqueUsername(TestCase):
    ...
    def test_clean_username(self):
        ...
        eq_(unique_username('Allan Lasser'), 'AllanLasser',
            'Spaces should be removed.')
        eq_(unique_username('allan@muckrock.com'), 'allan@muckrock.com',
            'Emails should be valid usernames.')
        eq_(unique_username('???dark$$$money!!!'), 'darkmoney',
            'Illegal symbols should be removed.')
        eq_(unique_username('?security=vulnerability'), 'securityvulnerability',
    ...
    def test_existing_username(self):
        ...
        eq_(unique_username(name), 'Highlander1',
