...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('news_article_foias', ['article_id', 'foiarequest_id'])

        # Changing field 'Article.image'
        db.alter_column('news_article', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Article.image'
        db.alter_column('news_article', 'image', self.gf('django.db.models.fields.files.ImageField')())
