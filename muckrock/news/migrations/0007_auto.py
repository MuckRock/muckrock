...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('news_article_editors', ['article_id', 'user_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 21, 24, 47, 216503)'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 21, 24, 47, 216407)'}),
        ...
        'news.article': {
            ...
            'editors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'edited_articles'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
