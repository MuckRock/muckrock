...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'news_article', ['slug', 'pub_date'])

        # Adding unique constraint on 'Article', fields ['slug']
        db.create_unique(u'news_article', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Article', fields ['slug']
        db.delete_unique(u'news_article', ['slug'])

        # Adding unique constraint on 'Article', fields ['slug', 'pub_date']
        db.create_unique(u'news_article', ['slug', 'pub_date'])
