...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.parent'
        db.add_column(u'agency_agency', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['agency.Agency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.parent'
        db.delete_column(u'agency_agency', 'parent_id')
