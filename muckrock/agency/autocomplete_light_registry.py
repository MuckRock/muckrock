...
class AgencyAutocomplete(autocomplete_light.AutocompleteModelTemplate):
    ...
    def choices_for_request(self):
        ...
        if jurisdiction_id:
            self.choices = self._filter_by_jurisdiction(self.choices, jurisdiction_id)
...
class AgencyEasySearchAutocomplete(autocomplete_light.AutocompleteModelTemplate):
    """Provides an autocomplete field for composing requests"""

    choices = Agency.objects.select_related("jurisdiction__parent").only(
        "name",
        "exempt",
        "jurisdiction__name",
        "jurisdiction__level",
...
class AgencyAppealAdminAutocomplete(AgencyAdminAutocomplete):
    ...
    def _filter_by_jurisdiction(self, choices, jurisdiction_id):
        ...
        if jurisdiction.level == "l":
            ...
            # parent level
            return choices.filter(jurisdiction__in=(jurisdiction, jurisdiction.parent))
        else:
