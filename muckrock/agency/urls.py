...
urlpatterns = patterns('',
    ...
    url(r'^view/%s/$' % old_agency_url,
        redirect_to, {'url': '/agency/%(jurisdiction)s/%(slug)s-%(idx)s/'}),
    url(r'^update/%s/$' % old_agency_url,                              
        redirect_to, {'url': '/agency/%(jurisdiction)s/%(slug)s-%(idx)s/update/'}),
    url(r'^flag/%s/$' % old_agency_url,                                
        redirect_to, {'url': '/agency/%(jurisdiction)s/%(slug)s-%(idx)s/flag/'}),
)
