...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RodeoVote.user'
        db.alter_column('rodeo_rodeovote', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'RodeoVote.user'
        db.alter_column('rodeo_rodeovote', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'rodeo.rodeooption': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rodeo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'options'", 'to': "orm['rodeo.Rodeo']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '70'})
        },
        'rodeo.rodeovote': {
            'Meta': {'object_name': 'RodeoVote'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': "orm['rodeo.RodeoOption']"}),
