...
urlpatterns = patterns('',
    url(r'^$',            views.List.as_view(template_name='lists/question_list.html'), name='question-index'),
    ...
    url(r'^(?P<slug>[\w\d_-]+)-(?P<pk>\d+)$',
                          views.Detail.as_view(template_name='details/question_detail.html'), name='question-detail'),
