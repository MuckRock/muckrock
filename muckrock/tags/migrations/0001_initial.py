...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaggedItemBase'
        db.create_table('tags_taggeditembase', (
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags_taggeditembase_items', to=orm['tags.Tag'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags_taggeditembase_tagged_items', to=orm['contenttypes.ContentType'])),
