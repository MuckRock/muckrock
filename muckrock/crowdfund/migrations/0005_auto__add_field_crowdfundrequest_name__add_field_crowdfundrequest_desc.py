...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrowdfundRequest.name'
        db.add_column(u'crowdfund_crowdfundrequest', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Crowdfund this request', max_length=255),
                      keep_default=False)

        # Adding field 'CrowdfundRequest.description'
        db.add_column(u'crowdfund_crowdfundrequest', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrowdfundRequest.name'
        db.delete_column(u'crowdfund_crowdfundrequest', 'name')

        # Deleting field 'CrowdfundRequest.description'
        db.delete_column(u'crowdfund_crowdfundrequest', 'description')
