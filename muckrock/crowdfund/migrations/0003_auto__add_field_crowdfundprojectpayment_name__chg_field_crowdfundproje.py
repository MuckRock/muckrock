...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrowdfundProjectPayment.name'
        db.add_column(u'crowdfund_crowdfundprojectpayment', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'CrowdfundProjectPayment.user'
        db.alter_column(u'crowdfund_crowdfundprojectpayment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
        # Adding field 'CrowdfundRequestPayment.name'
        db.add_column(u'crowdfund_crowdfundrequestpayment', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'CrowdfundRequestPayment.user'
        db.alter_column(u'crowdfund_crowdfundrequestpayment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'CrowdfundProjectPayment.name'
        db.delete_column(u'crowdfund_crowdfundprojectpayment', 'name')
        ...
        # Deleting field 'CrowdfundRequestPayment.name'
        db.delete_column(u'crowdfund_crowdfundrequestpayment', 'name')
    ...
    models = {
        ...
        u'crowdfund.crowdfundproject': {
            ...
            'payments': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'through': u"orm['crowdfund.CrowdfundProjectPayment']", 'symmetrical': 'False'}),
            'project': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'crowdfund'", 'unique': 'True', 'to': u"orm['crowdfund.Project']"})
        },
        u'crowdfund.crowdfundprojectpayment': {
            'Meta': {'object_name': 'CrowdfundProjectPayment'},
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'crowdfund': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crowdfund.CrowdfundProject']"}),
        ...
        u'crowdfund.crowdfundrequest': {
            ...
            'date_due': ('django.db.models.fields.DateField', [], {}),
            'foia': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'crowdfund'", 'unique': 'True', 'to': u"orm['foia.FOIARequest']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment_received': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '8', 'decimal_places': '2'}),
            'payment_required': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '8', 'decimal_places': '2'}),
            'payments': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'through': u"orm['crowdfund.CrowdfundRequestPayment']", 'symmetrical': 'False'})
        },
        ...
        u'crowdfund.project': {
            ...
            'foias': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'foias'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['foia.FOIARequest']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255'})
        },
