...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrowdfundProjectPayment.show'
        db.add_column(u'crowdfund_crowdfundprojectpayment', 'show',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CrowdfundRequestPayment.show'
        db.add_column(u'crowdfund_crowdfundrequestpayment', 'show',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrowdfundProjectPayment.show'
        db.delete_column(u'crowdfund_crowdfundprojectpayment', 'show')

        # Deleting field 'CrowdfundRequestPayment.show'
        db.delete_column(u'crowdfund_crowdfundrequestpayment', 'show')
