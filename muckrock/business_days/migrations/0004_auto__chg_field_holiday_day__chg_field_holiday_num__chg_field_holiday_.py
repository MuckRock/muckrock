...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('business_days_holiday', 'day', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True))

        # Changing field 'Holiday.num'
        db.alter_column('business_days_holiday', 'num', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True))

        # Changing field 'Holiday.weekday'
        db.alter_column('business_days_holiday', 'weekday', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True))

        # Changing field 'Holiday.month'
        db.alter_column('business_days_holiday', 'month', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True))
