...
class FOIACommunicationInline(admin.StackedInline):
    ...
    def comm_type(self, instance):
        """How was this communication delivered?"""
        if instance.email_count > 0:
            return 'Email'
        elif instance.fax_count > 0:
            return 'Fax'
        elif instance.mail_count > 0:
            return 'Mail'
        elif instance.web_count > 0:
            return 'Web'
        else:
            return ''
