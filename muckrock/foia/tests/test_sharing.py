...
class TestRequestSharing(TestCase):
    ...
    def test_editor_permission(self):
        ...
        new_editor = self.editor
        self.foia.add_editor(new_editor)
        ok_(new_editor.has_perm('foia.change_foiarequest', self.foia))
    ...
    def test_viewer_permission(self):
        ...
        assert_true(viewer.has_perm('foia.view_foiarequest', embargoed_foia))
        assert_false(normie.has_perm('foia.view_foiarequest', embargoed_foia))
    ...
    def test_promote_viewer(self):
        ...
        embargoed_foia.add_viewer(viewer)
        assert_true(viewer.has_perm('foia.view_foiarequest', embargoed_foia))
        assert_false(viewer.has_perm('foia.change_foiarequest', embargoed_foia))
        embargoed_foia.promote_viewer(viewer)
        assert_true(viewer.has_perm('foia.change_foiarequest', embargoed_foia))
    ...
    def test_demote_editor(self):
        ...
        assert_true(editor.has_perm('foia.view_foiarequest', embargoed_foia))
        assert_true(editor.has_perm('foia.change_foiarequest', embargoed_foia))
        embargoed_foia.demote_editor(editor)
        assert_false(editor.has_perm('foia.change_foiarequest', embargoed_foia))
    ...
    def test_creator_access(self):
        ...
        assert_true(self.creator.has_perm('foia.change_foiarequest', self.foia))
        assert_true(self.creator.has_perm('foia.view_foiarequest', self.foia))
