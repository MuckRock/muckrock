...
from muckrock.foia.filters import FOIALogEntryFilterSet
...
class FOIALogUploadView(UserPassesTestMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        num = import_logs(form, self.request.user)
...
class FOIALogList(MRSearchFilterListView):
    ...
    foia = None
    filter_class = FOIALogEntryFilterSet
    title = "FOIA Logs"
    ...
    def get_queryset(self):
        ...
        return super().get_queryset().select_related("foia_log__agency__jurisdiction")
