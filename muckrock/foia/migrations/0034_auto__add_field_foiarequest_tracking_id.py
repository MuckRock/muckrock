...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FOIARequest.tracking_id'
        db.add_column('foia_foiarequest', 'tracking_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'FOIARequest.tracking_id'
        db.delete_column('foia_foiarequest', 'tracking_id')
