...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FOIAFile.pages'
        db.add_column('foia_foiafile', 'pages', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'FOIAFile.access'
        db.add_column('foia_foiafile', 'access', self.gf('django.db.models.fields.CharField')(default='public', max_length=12), keep_default=False)

        # Adding field 'FOIAFile.doc_id'
        db.add_column('foia_foiafile', 'doc_id', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=80, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FOIAFile.pages'
        db.delete_column('foia_foiafile', 'pages')

        # Deleting field 'FOIAFile.access'
        db.delete_column('foia_foiafile', 'access')
