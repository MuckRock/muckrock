...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FOIAFile.source'
        db.add_column('foia_foiafile', 'source', self.gf('django.db.models.fields.CharField')(default='', max_length=70, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FOIAFile.source'
        db.delete_column('foia_foiafile', 'source')
