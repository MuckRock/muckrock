...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIARequest.permanent_embargo'
        db.add_column(u'foia_foiarequest', 'permanent_embargo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIARequest.permanent_embargo'
        db.delete_column(u'foia_foiarequest', 'permanent_embargo')
