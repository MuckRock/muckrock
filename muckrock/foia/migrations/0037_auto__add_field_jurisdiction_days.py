...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Jurisdiction.days'
        db.add_column('foia_jurisdiction', 'days', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Jurisdiction.days'
        db.delete_column('foia_jurisdiction', 'days')
    ...
    models = {
        ...
        'foia.jurisdiction': {
            ...
            'days': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
