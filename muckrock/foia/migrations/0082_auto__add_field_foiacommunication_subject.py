...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIACommunication.subject'
        db.add_column(u'foia_foiacommunication', 'subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIACommunication.subject'
        db.delete_column(u'foia_foiacommunication', 'subject')
    ...
    models = {
        ...
        'foia.rawemail': {
            ...
            'communication': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['foia.FOIACommunication']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
