...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIARequest.disable_autofollowups'
        db.add_column(u'foia_foiarequest', 'disable_autofollowups',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIARequest.disable_autofollowups'
        db.delete_column(u'foia_foiarequest', 'disable_autofollowups')
