...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIACommunication.delivered'
        db.add_column('foia_foiacommunication', 'delivered',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIACommunication.delivered'
        db.delete_column('foia_foiacommunication', 'delivered')
