...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FOIAFile.comm'
        db.add_column('foia_foiafile', 'comm', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='files', null=True, to=orm['foia.FOIACommunication']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'FOIAFile.comm'
        db.delete_column('foia_foiafile', 'comm_id')
