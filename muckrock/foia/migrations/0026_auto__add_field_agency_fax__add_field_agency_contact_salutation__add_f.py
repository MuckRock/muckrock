...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agency.contact_salutation'
        db.add_column('foia_agency', 'contact_salutation', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'Agency.contact_last_name'
        db.add_column('foia_agency', 'contact_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Agency.phone'
        db.add_column('foia_agency', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'Agency.url'
        ...
        # Adding field 'Agency.user'
        db.add_column('foia_agency', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'Agency.notes'
        db.add_column('foia_agency', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Agency.contact_title'
        db.add_column('foia_agency', 'contact_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Agency.contact_salutation'
        db.delete_column('foia_agency', 'contact_salutation')

        # Deleting field 'Agency.contact_last_name'
        db.delete_column('foia_agency', 'contact_last_name')

        # Deleting field 'Agency.phone'
        db.delete_column('foia_agency', 'phone')

        # Deleting field 'Agency.url'
        db.delete_column('foia_agency', 'url')

        # Deleting field 'Agency.other_emails'
        db.delete_column('foia_agency', 'other_emails')

        # Deleting field 'Agency.expires'
        db.delete_column('foia_agency', 'expires')

        # Deleting field 'Agency.user'
        db.delete_column('foia_agency', 'user_id')

        # Deleting field 'Agency.notes'
        db.delete_column('foia_agency', 'notes')

        # Deleting field 'Agency.contact_title'
        db.delete_column('foia_agency', 'contact_title')
    ...
    models = {
        ...
        'foia.foiadoctopviewed': {
            ...
            'doc': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['foia.FOIADocument']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
