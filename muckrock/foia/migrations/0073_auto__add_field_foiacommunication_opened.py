...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIACommunication.opened'
        db.add_column(u'foia_foiacommunication', 'opened',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIACommunication.opened'
        db.delete_column(u'foia_foiacommunication', 'opened')
