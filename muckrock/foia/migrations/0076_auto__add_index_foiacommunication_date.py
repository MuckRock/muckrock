...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'FOIACommunication', fields ['date']
        db.create_index(u'foia_foiacommunication', ['date'])


    def backwards(self, orm):
        # Removing index on 'FOIACommunication', fields ['date']
        db.delete_index(u'foia_foiacommunication', ['date'])
