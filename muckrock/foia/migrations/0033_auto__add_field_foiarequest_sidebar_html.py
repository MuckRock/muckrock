...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FOIARequest.sidebar_html'
        db.add_column('foia_foiarequest', 'sidebar_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'FOIARequest.sidebar_html'
        db.delete_column('foia_foiarequest', 'sidebar_html')
