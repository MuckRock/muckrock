...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FOIARequest.tracker'
        db.add_column('foia_foiarequest', 'tracker', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'FOIARequest.tracker'
        db.delete_column('foia_foiarequest', 'tracker')
