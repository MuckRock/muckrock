...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FOIAFile.title'
        db.alter_column(u'foia_foiafile', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'FOIAFile.source'
        db.alter_column(u'foia_foiafile', 'source', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'FOIAFile.title'
        db.alter_column(u'foia_foiafile', 'title', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'FOIAFile.source'
        db.alter_column(u'foia_foiafile', 'source', self.gf('django.db.models.fields.CharField')(max_length=70))
    ...
    models = {
        ...
        u'foia.foiacommunication': {
            ...
            'foia': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'communications'", 'to': u"orm['foia.FOIARequest']"}),
