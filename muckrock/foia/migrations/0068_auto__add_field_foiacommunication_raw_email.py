...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIACommunication.raw_email'
        db.add_column('foia_foiacommunication', 'raw_email',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIACommunication.raw_email'
        db.delete_column('foia_foiacommunication', 'raw_email')
