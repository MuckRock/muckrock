...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agency.name'
        db.alter_column('foia_agency', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
    
    
    def backwards(self, orm):
        
        # Changing field 'Agency.name'
        db.alter_column('foia_agency', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))
