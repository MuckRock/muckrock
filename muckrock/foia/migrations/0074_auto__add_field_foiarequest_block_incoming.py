...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIARequest.block_incoming'
        db.add_column(u'foia_foiarequest', 'block_incoming',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIARequest.block_incoming'
        db.delete_column(u'foia_foiarequest', 'block_incoming')
