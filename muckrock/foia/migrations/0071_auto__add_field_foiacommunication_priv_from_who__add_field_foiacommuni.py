...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIACommunication.priv_from_who'
        db.add_column(u'foia_foiacommunication', 'priv_from_who',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FOIACommunication.priv_to_who'
        db.add_column(u'foia_foiacommunication', 'priv_to_who',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIACommunication.priv_from_who'
        db.delete_column(u'foia_foiacommunication', 'priv_from_who')

        # Deleting field 'FOIACommunication.priv_to_who'
        db.delete_column(u'foia_foiacommunication', 'priv_to_who')
