...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('foia_foiarequest', (
            ...
            ('agency', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('date_done', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('date_submitted', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('jurisdiction', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ...
        db.send_create_signal('foia', ['FOIARequest'])
        ...
        db.create_table('foia_foiaimage', (
            ...
            ('page', self.gf('django.db.models.fields.SmallIntegerField')(unique=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
