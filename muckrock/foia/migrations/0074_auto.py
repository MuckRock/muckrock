...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field read_collaborators on 'FOIARequest'
        m2m_table_name = db.shorten_name(u'foia_foiarequest_read_collaborators')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('foiarequest', models.ForeignKey(orm[u'foia.foiarequest'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['foiarequest_id', 'user_id'])

        # Adding M2M table for field edit_collaborators on 'FOIARequest'
        m2m_table_name = db.shorten_name(u'foia_foiarequest_edit_collaborators')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('foiarequest', models.ForeignKey(orm[u'foia.foiarequest'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field read_collaborators on 'FOIARequest'
        db.delete_table(db.shorten_name(u'foia_foiarequest_read_collaborators'))

        # Removing M2M table for field edit_collaborators on 'FOIARequest'
        db.delete_table(db.shorten_name(u'foia_foiarequest_edit_collaborators'))
    ...
    models = {
        ...
        u'foia.foiacommunication': {
            'Meta': {'ordering': "['foia', 'date']", 'object_name': 'FOIACommunication'},
        ...
        u'foia.foiafile': {
            'Meta': {'ordering': "['comm', 'date']", 'object_name': 'FOIAFile'},
        ...
        u'foia.foiarequest': {
            ...
            'edit_collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'edit_collaborators'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            'embargo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'read_collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'read_collaborators'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            'requested_docs': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
