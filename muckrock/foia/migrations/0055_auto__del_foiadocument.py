...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('foia_foiadocument', (
            ...
            ('access', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ...
            ('doc_id', self.gf('django.db.models.fields.SlugField')(max_length=80, db_index=True)),
