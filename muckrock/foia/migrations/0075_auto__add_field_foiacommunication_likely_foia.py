...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIACommunication.likely_foia'
        db.add_column(u'foia_foiacommunication', 'likely_foia',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='likely_communications', null=True, to=orm['foia.FOIARequest']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIACommunication.likely_foia'
        db.delete_column(u'foia_foiacommunication', 'likely_foia_id')
