...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FOIAMultiRequest.status'
        db.add_column('foia_foiamultirequest', 'status',
                      self.gf('django.db.models.fields.CharField')(default='started', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FOIAMultiRequest.status'
        db.delete_column('foia_foiamultirequest', 'status')
