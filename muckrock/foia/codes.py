...
CODES = {
    'ACK': (
        'Acknowledgement Letter', 'processed',
        'An acknowledgement letter, stating the request is being processed.'
    ),
    'NRD': (
        'No Responsive Documents', 'no_docs',
    ...
    'REJ-G': (
        'Glomar Response', 'rejected',
        'The request has been rejected, with the agency stating that it can neither confirm nor deny the existence of the requested documents.'
    ),
    'REJ-E': (
        'Materials exempt from disclosure', 'rejected',
        'The request has been rejected, with the agency stating that the information or document(s) requested are exempt from disclosure.'
    ),
    'REJ-P': (
        'Rejected, proxy required', 'rejected',
        'The request has been rejected with the agency stating that you must be a resident of the state. MuckRock is working with our in-state volunteers to refile this request, and it should appear in your account within a few days.'
    ),
    'REJ': (
        'Request rejected', 'rejected',
    ...
    'FIX-D': (
        'Fix Required', 'fix',
        'A fix is required to perfect the request. The agency has asked the requester to specify a date range for the requested materials.'
    ),
    'FIX-F': (
        'Fee Agreement Required', 'fix',
        'The user must agree to pay fees in order for the process to be continued being processed.  No payment is due at this time.'
    ),
    'FIX-V': (
        'Fix Required', 'fix',
    ...
    'APP-ACK': (
        'Appeal Acknowledgement', 'appealing',
