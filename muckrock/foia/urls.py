...
urlpatterns = patterns('',
    ...
    url(r'^multi/(?P<slug>[\w\d_-]+)-(?P<idx>\d+)/submit_multiple/$',
                                           views.submit_multiple, name='foia-submit-multiple'),
    url(r'^multi/(?P<slug>[\w\d_-]+)-(?P<idx>\d+)/confirm_multiple/$',
                                           views.confirm_multiple, name='foia-confirm-multiple'),
    url(r'^multi/(?P<slug>[\w\d_-]+)-(?P<idx>\d+)/update/$',
                                           views.multirequest_update, name='foia-multi-update'),
    url(r'^multi/(?P<slug>[\w\d_-]+)-(?P<idx>\d+)/$',
                                           RedirectView.as_view(url='update')),
