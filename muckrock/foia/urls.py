...
urlpatterns = patterns('',
    ...
    url(r'^list/place-(?P<jurisdiction>[\w\d_.@ -]+)-(?P<idx>\d+)/$',
        views.ListByJurisdiction.as_view(template_name=list_template), name='foia-list-jurisdiction'),
    url(r'^list/tag-(?P<tag_slug>[\w\d_.@-]+)/$',
        views.ListByTag.as_view(template_name=list_template), name='foia-list-tag'),
