...
urlpatterns = [
    url(r"^$", views.JurisdictionExploreView.as_view(), name="jurisdiction-explore",),
    url(r"^embed/$", views.JurisdictionEmbedView.as_view(), name="jurisdiction-embed",),
    url(r"^list/$", views.List.as_view(), name="jurisdiction-list",),
