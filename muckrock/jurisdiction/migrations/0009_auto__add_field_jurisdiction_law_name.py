...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jurisdiction.law_name'
        db.add_column(u'jurisdiction_jurisdiction', 'law_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jurisdiction.law_name'
        db.delete_column(u'jurisdiction_jurisdiction', 'law_name')
