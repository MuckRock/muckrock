...
class Migration(migrations.Migration):
    ...
    dependencies = [("business_days", "0001_initial")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=1,
                        choices=[("f", "Federal"), ("s", "State"), ("l", "Local")],
                    ),
                ),
                ...
                (
                    "observe_sat",
                    models.BooleanField(
                        help_text="Are holidays observed on Saturdays? (or are they moved to Friday?)"
                    ),
                ),
                (
                    "use_business_days",
                ...
                (
                    "law_name",
                    models.CharField(
                        help_text="The pertinant FOIA law", max_length=255, blank=True
                    ),
                ),
                (
                    "waiver",
                ...
                (
                    "holidays",
                    models.ManyToManyField(to="business_days.Holiday", blank=True),
                ),
                (
                    "parent",
                    models.ForeignKey(
        ...
        migrations.AlterUniqueTogether(
            name="jurisdiction", unique_together=set([("slug", "parent")])
        ),
    ]
