...
AWS_S3_MAX_MEMORY_SIZE = int(
    os.environ.get('AWS_S3_MAX_MEMORY_SIZE', 16 * 1024 * 1024)
)
AWS_S3_MIN_PART_SIZE = int(
    os.environ.get('AWS_S3_MIN_PART_SIZE', 16 * 1024 * 1024)
)
...
LOB_PUBLIC_KEY = os.environ.get('LOB_PUBLIC_KEY')
LOB_WEBHOOK_KEY = os.environ.get('LOB_WEBHOOK_KEY', 'secret')

SLACK_WEBHOOK_URL = os.environ.get('SLACK_WEBHOOK_URL', '')
AUTO_LOB = boolcheck(os.environ.get('AUTO_LOB', False))
