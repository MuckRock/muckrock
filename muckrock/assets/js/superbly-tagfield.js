    ...
    function superblyTagField(tagField,settings) {
        ...
        tagInput.keydown(function(e){
            if(e.keyCode == keyMap.downArrow) {		
                ...
                selectUp()
            }else if(e.keyCode == keyMap.enter || e.keyCode == keyMap.tab || e.keyCode == keyMap.comma) {
                if(currentItem != null){
                    addItem(currentItem);
                ...
                // prevent default action for enter and comma
                return e.keyCode != keyMap.enter && e.keyCode != keyMap.comma; 
