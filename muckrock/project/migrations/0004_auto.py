...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field articles on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_articles')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'article_id'])


    def backwards(self, orm):
        # Removing M2M table for field articles on 'Project'
        db.delete_table(db.shorten_name(u'project_project_articles'))
    ...
    models = {
        ...
        u'project.project': {
            ...
            'articles': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects'", 'symmetrical': 'False', 'to': u"orm['news.Article']"}),
            'contributors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
