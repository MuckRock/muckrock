...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'project_project', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2015, 6, 17, 0, 0), unique=True, max_length=255),
                      keep_default=False)

        # Adding unique constraint on 'Project', fields ['title']
        db.create_unique(u'project_project', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['title']
        db.delete_unique(u'project_project', ['title'])
