...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field requests on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_requests')
    ...
    def backwards(self, orm):
        # Removing M2M table for field requests on 'Project'
        db.delete_table(db.shorten_name(u'project_project_requests'))
