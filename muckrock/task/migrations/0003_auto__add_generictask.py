...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GenericTask'
        db.create_table(u'task_generictask', (
        ...
        db.send_create_signal(u'task', ['GenericTask'])


    def backwards(self, orm):
        # Deleting model 'GenericTask'
        db.delete_table(u'task_generictask')
