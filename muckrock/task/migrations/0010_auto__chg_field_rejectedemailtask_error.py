...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RejectedEmailTask.error'
        db.alter_column(u'task_rejectedemailtask', 'error', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'RejectedEmailTask.error'
        db.alter_column(u'task_rejectedemailtask', 'error', self.gf('django.db.models.fields.CharField')(max_length=255))
