...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaymentTask.amount'
        db.alter_column(u'task_paymenttask', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PaymentTask.amount'
        db.alter_column(u'task_paymenttask', 'amount', self.gf('django.db.models.fields.IntegerField')())
