...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='switch',
            field=models.BooleanField(default=False, help_text=b'Designates we have switched to sending to this address from another form of communication due to some sort of error.  A note should be included in the communication with an explanation.'),
        ),
    ]
