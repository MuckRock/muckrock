...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.resolved_by'
        db.add_column(u'task_task', 'resolved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resolved_tasks', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.resolved_by'
        db.delete_column(u'task_task', 'resolved_by_id')
