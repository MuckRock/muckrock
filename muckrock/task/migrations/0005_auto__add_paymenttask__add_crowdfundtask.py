...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'task_paymenttask', (
        ...
        db.send_create_signal(u'task', ['PaymentTask'])

        # Adding model 'CrowdfundTask'
        db.create_table(u'task_crowdfundtask', (
            (u'task_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['task.Task'], unique=True, primary_key=True)),
            ('crowdfund', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crowdfund.CrowdfundRequest'])),
        ))
        db.send_create_signal(u'task', ['CrowdfundTask'])


    def backwards(self, orm):
        # Deleting model 'PaymentTask'
        db.delete_table(u'task_paymenttask')

        # Deleting model 'CrowdfundTask'
        db.delete_table(u'task_crowdfundtask')
