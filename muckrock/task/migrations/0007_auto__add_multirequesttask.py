...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MultiRequestTask'
        db.create_table(u'task_multirequesttask', (
            (u'task_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['task.Task'], unique=True, primary_key=True)),
            ('multirequest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foia.FOIAMultiRequest'])),
        ))
        db.send_create_signal(u'task', ['MultiRequestTask'])


    def backwards(self, orm):
        # Deleting model 'MultiRequestTask'
        db.delete_table(u'task_multirequesttask')
