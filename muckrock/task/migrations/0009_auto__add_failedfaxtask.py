...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FailedFaxTask'
        db.create_table(u'task_failedfaxtask', (
        ...
        db.send_create_signal(u'task', ['FailedFaxTask'])


    def backwards(self, orm):
        # Deleting model 'FailedFaxTask'
        db.delete_table(u'task_failedfaxtask')
