...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrphanTask.address'
        db.add_column(u'task_orphantask', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


        # Changing field 'NewAgencyTask.user'
        db.alter_column(u'task_newagencytask', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'OrphanTask.address'
        db.delete_column(u'task_orphantask', 'address')


        # User chose to not deal with backwards NULL issues for 'NewAgencyTask.user'
        raise RuntimeError("Cannot reverse this migration. 'NewAgencyTask.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'NewAgencyTask.user'
        db.alter_column(u'task_newagencytask', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
