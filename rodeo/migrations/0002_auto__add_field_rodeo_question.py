...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rodeo.question'
        db.add_column('rodeo_rodeo', 'question', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Rodeo.question'
        db.delete_column('rodeo_rodeo', 'question')
