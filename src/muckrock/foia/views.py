...
def _save_foia_comm(request, foia, form, is_appeal=False):
    ...
    foia.save()
    foia.submit(appeal=is_appeal)

def _save_appeal(request, foia, form):
    """Save a communication as an appeal"""
    _save_foia_comm(request, foia, form, is_appeal=True)
