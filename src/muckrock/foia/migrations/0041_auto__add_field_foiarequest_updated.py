...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FOIARequest.updated'
        db.add_column('foia_foiarequest', 'updated', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'FOIARequest.updated'
        db.delete_column('foia_foiarequest', 'updated')
