...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FOIACommunication.to_who'
        db.add_column('foia_foiacommunication', 'to_who', self.gf('django.db.models.fields.CharField')(default='', max_length=70, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'FOIACommunication.to_who'
        db.delete_column('foia_foiacommunication', 'to_who')
