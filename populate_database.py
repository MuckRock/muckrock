...
federal = Jurisdiction.objects.create(
    name='United States of America',
    slug='united-states-of-america',
    level='f',
)
state = Jurisdiction.objects.create(
    name='New Jersey',
    slug='new-jersey',
    abbrev='NJ',
    level='s',
...
local = Jurisdiction.objects.create(
    name='Newark',
    slug='newark-nj',
    level='l',
    parent=state
...
nj_gov = Agency.objects.create(
    name='Governor\'s Office',
    slug='nj-governors-office',
    jurisdiction=state,
    approved=True,
)
newark_mayor = Agency.objects.create(
    name='Mayor\'s Office',
    slug='nj-mayors-office',
    jurisdiction=local,
    approved=True,
)
